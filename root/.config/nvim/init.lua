...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-p>', builtin.find_files, { desc = '' })
...

  {
    ...
    lazy = false,
    opts = {
      notifier = { enabled = true, style = 'compact', level = vim.log.levels.INFO },
    },
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        --  the list of additional_vim_rhttp://vimregex.com/egex_highlighting and disabled languages for indent.
